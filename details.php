...
<div class="container">
    ...
    <!-- SIGNUP FORM -->
            ...
            <div class="signup-form">
                ...
                <input type="g_id"  id="g_id" name="g_id" placeholder="Gruop_id" aria-describedby="emailHelp" required>
           
                <label for="team_name" >Team Name*</label>
                <input type="team_name"  id="team_name" name="team_name" placeholder="Team_name" aria-describedby="emailHelp" required>
                <br>  
          ...
          <div class="signup-form">
                ...
                <input type="M_id"  id="M_id" name="M_id" placeholder="M_id" aria-describedby="emailHelp" required>
           
                <label for="M_name" >Mentor Name*</label>
                <input type="M_name"  id="M_name" name="M_name" placeholder="M_name" aria-describedby="emailHelp" required>
                <br>
                <label for="M_PH_no" >Mentor Mobile number*</label>
                <input type="M_PH_no"  id="M_PH_no" name="M_PH_no" placeholder="M_PH_no" aria-describedby="emailHelp" required>
                <br> 
                <label for="M_email" >Mentor Email id*</label>
                <input type="M_email"  id="M_email" name="M_email" placeholder="M_email" aria-describedby="emailHelp" required>
                <br>    
          </div>
          </div>
          ...
          <h4>Enter student Details</h4>
                ...
                <input type="s_name"  id="s_name" name="s_name" placeholder="s_name" aria-describedby="emailHelp" required>
                <br>
                ...
                <input type="S_PH_no"  id="S_PH_no" name="S_PH_no" placeholder="S_PH_no" aria-describedby="emailHelp" required>
                <br> 
                <label for="S_email" >Student Email id*</label>
                <input type="S_email"  id="S_email" name="S_email" placeholder="S_email" aria-describedby="emailHelp" required>
                <br>    
          </div>
          </div>
        </div>
